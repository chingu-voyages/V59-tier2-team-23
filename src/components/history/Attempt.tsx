    ...
    return (
        <div className='border p-[1rem] rounded-[0.5rem] my-[1rem]'>
            ...
            <div className={`flex justify-between w-full leading-none text-[1rem]  ${className}`} {...props}>
                ...
                <NavLink to={`/history/${attempt.id}`} className='h-full p-[0.5rem] text-center w-[5rem] text-[1rem] rounded-lg bg-gray-800 py-3 text-white font-semibold
            hover:bg-gray-600 transition disabled:opacity-50 disabled:cursor-not-allowed hover:bg-gray-600 transition'>Review</NavLink>
            </div>
        </div>);
}
