    ...
    >
      ...
      {isAuthLoading ? (
        <div className="w-ful h-screen flex justify-center items-center">
          <FaSpinner className="animate-spin h-14 w-14 " />
        </div>
      ) : (
        <>
          {" "}
          ...
          <p className="text-[1.2rem]">
            ...
            questions. Providing a selection of industry relevant questions
            along with their answers and amplifying informaiton for the most
            popular roles in the tech industry.
            <br />
