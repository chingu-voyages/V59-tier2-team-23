  ...
  return (
    ...
    >
      ...
      <p className="text-[1.2rem] max-w-250 fluid-section-padding">
        Quizest is your handy source to prepare for interviewing for the most
        popular roles in the tech industry. We provide a selection of industry
        relevant questions along with their answers and deep-diving
        explanations, a personal History so you can track your progress, a
        Leaderboard to motivate you on your journey, and an AI agent to practice
        interview questions with conversationally.
        {/* <br /> */}
