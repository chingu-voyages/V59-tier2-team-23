        ...
        <div className="max-w-md w-full bg-gray-100 rounded-lg shadow-lg p-8">
          <div className="mb-6">
            ...
            <p className="text-sm text-gray-600">
              To learn more about any of the roles, please select a role and
              click "Learn More About Role" before proceeding. Otherwise simply
              select a role and click "Continue" to proceed.
            </p>
          </div>
